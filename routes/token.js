...
const Contract = let.contract(ABI);
...
module.exports = function(req, res){
  ...
  if (!("action" in req.body))
    ...
    try {
      var actualBalance = let.getBalance(contractAddress);
      ...
      var count = let.getTransactionCount(contractAddress);
      var tokenData = {
        ...
        "name": name,
        "symbol": symbol,
        "bytecode": let.getCode(contractAddress)
      }
